...
export function normalizeSavedCommunicationPreferences(row = null) {
  ...
  // Historical V3 default records persisted a full Natural/Balanced snapshot
  // even when the user never customized anything. Treat the default preset as
  // Automatic so those legacy snapshots cannot accidentally block learning.
