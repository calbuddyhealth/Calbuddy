...
export function buildDreamModelPayload(evidence = {}) {
  return {
    ...
    affectivePreferenceState: evidence?.cognitiveState?.affectivePreferenceState || null,
    affectivePreferenceHistory: (evidence?.cognitiveState?.affectivePreferenceState?.history || []).slice(0, 8),
    learnedAffectivePreferences: (evidence?.cognitiveState?.affectivePreferenceState?.learnedPreferences || []).slice(0, 12),
