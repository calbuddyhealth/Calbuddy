...
export function dreamInstructions() {
  return [
    ...
    "Do not infer that an emotion was useful merely because its label appeared. Require observable downstream differences or repeated outcome patterns. A functional emotion may become a strategy-level lesson only when its causal role is supported by evidence.",
