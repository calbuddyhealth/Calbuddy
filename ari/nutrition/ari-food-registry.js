...
(function initializeAriFoodRegistry(global) {
  ...
  /**
   * normalized name -> Set(foodId)
   */
  const nameIndex = new Map();


  /**
   * normalized alias -> Set(foodId)
   */
  const aliasIndex = new Map();


  /**
   * preparation -> Set(foodId)
   */
  const preparationIndex = new Map();


  /**
   * food state -> Set(foodId)
   *
   * Examples:
   * raw
   * cooked
  ...
  /**
   * data source -> Set(foodId)
   */
  const sourceIndex = new Map();


  /**
   * brand / restaurant -> Set(foodId)
   */
  ...
  /**
   * The nutrition basis defines exactly what quantity
   * the nutrition object represents.
   *
   * WEIGHT EXAMPLE
   *
   * nutritionBasis: {
  ...
  function normalizeNutritionBasis(
    ...
    // Automatically resolve known weight units.
    if (
      type === "weight" &&
      grams === null
    ) {
    ...
    // Automatically resolve known volume units.
    if (
      type === "volume" &&
      milliliters === null
    ) {
  ...
  /**
   * Servings represent convenient ways a person may
   * describe the food.
   *
   * Example:
   *
  ...
  function normalizeFood(
    ...
    return {
      ...
      // ---------------------------------------------------
      // Human-friendly serving options
      // ---------------------------------------------------

      servings,

      // ---------------------------------------------------
      // Derived measurement capabilities
      // ---------------------------------------------------
  ...
  /**
   * AriFoodSearch will consume these documents.
   *
   * Search remains separate from registry logic.
   */
