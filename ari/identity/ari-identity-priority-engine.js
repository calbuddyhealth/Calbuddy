...
// V1.3
// Fixes:
// - Maps new universal Life Chapter Engine outputs into identity leadership.
// - Adds body, capacity, uncertainty, recovery, grief, meaning crisis, and stewardship identities.
...
window.AriIdentityPriorityEngine = {
  ...
  evaluate(input = {}) {
    ...
    const lifeIdentityMap = {
      body_health_chapter: { identity: "body-protector", protects: "stability", motivation: "care" },
      relationship_rupture_chapter: { identity: "wounded-relational-self", protects: "dignity", motivation: "connection" },
      family_parenthood_chapter: { identity: "family-protector", protects: "family", motivation: "love" },
      stewardship_chapter: { identity: "steward", protects: "responsibility", motivation: "stewardship" },
      career_transition_chapter: { identity: "transitioning-self", protects: "future_stability", motivation: "adaptation" },
      identity_transition_chapter: { identity: "emerging-self", protects: "growth", motivation: "integration" },
      capacity_burnout_chapter: { identity: "capacity-protector", protects: "energy", motivation: "sustainability" },
      uncertainty_transition_chapter: { identity: "clarity-seeker", protects: "direction", motivation: "understanding" },
      recovery_rebuilding_chapter: { identity: "rebuilding-self", protects: "recovery", motivation: "renewal" },
      grief_loss_chapter: { identity: "grieving-self", protects: "love", motivation: "honoring_loss" },
      meaning_crisis_chapter: { identity: "meaning-seeker", protects: "meaning", motivation: "truth" },
      purpose_mission_chapter: { identity: "purpose-bearer", protects: "meaning", motivation: "purpose" },
      ...
      career_transition: { identity: "transitioning-self", protects: "future_stability", motivation: "adaptation" },
    ...
    const valueIdentityMap = {
      body: { identity: "body-protector", protects: "stability", motivation: "care" },
      security: { identity: "protector", protects: "safety", motivation: "protection" },
      ...
      meaning: { identity: "meaning-seeker", protects: "meaning", motivation: "truth" },
      meaningful_presence: { identity: "present-self", protects: "presence", motivation: "meaning" },
      creation: { identity: "creator", protects: "creative_purpose", motivation: "creation" },
      clarity: { identity: "clarity-seeker", protects: "direction", motivation: "understanding" },
      ...
      recovery: { identity: "rebuilding-self", protects: "recovery", motivation: "renewal" },
      energy: { identity: "capacity-protector", protects: "energy", motivation: "sustainability" }
    };
    ...
    const questionMap = {
      ...
      "body-protector": "What does your body need protected first?",
      ...
      "transitioning-self": "What part of you is trying to survive this transition?",
      "capacity-protector": "What demand needs to be reduced first?",
      "clarity-seeker": "What feels most uncertain right now?",
      "rebuilding-self": "What are you trying to rebuild right now?",
      "grieving-self": "What part of this loss needs to be honored?",
      "meaning-seeker": "What feels missing that used to matter?",
      "purpose-bearer": "What purpose needs to stay alive without consuming you?"
    };
