...
assert.match(runtime, /ari-vnext-reference-state\.js\?v=1\.1\.0/, "runtime must boot the universal reference lifecycle");
...
assert.match(router, /ari-runtime-controller\.js\?v=1\.4\.0/, "shared Home/Nutrition router must boot the reference-aware unified runtime controller");
