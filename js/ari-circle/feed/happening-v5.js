/* ARI Circle V5 — live Meet Up discovery rail for the existing Feed. */
(() => {
  "use strict";
  const VERSION = "5.0.0";
  ...
  function ensureSection() {
    ...
    section.innerHTML=`<div class="circle-v5-section-heading"><div><p>HAPPENING</p><h2>Do something in real life</h2></div><a href="ari-circle-meetup.html">See all</a></div><div class="circle-v5-happening__rail" id="circleV5HappeningRail"></div>`;
  ...
  async function load() {
    ...
    try {
      ...
      if (!rows.length) {
        rail.innerHTML='<a class="circle-v5-happening-card" href="ari-circle-meetup.html"><span class="circle-v5-happening-card__eyebrow">MEET UP</span><h3>Nothing planned yet.</h3><p>Host something people can actually show up for.</p><div class="circle-v5-happening-card__footer"><span>Create a meetup</span><span>→</span></div></a>';
        return;
      }
